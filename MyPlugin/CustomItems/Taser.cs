...
namespace MyPlugin.CustomItems
{
    ...
    public class Taser : CustomItem
    {
        private static ItemType customItemType = MyPlugin.Instance.Config.Taser.CustomItemType;
        private static uint customItemTypeId = MyPlugin.Instance.Config.Taser.CustomItemTypeId;
        private static string CustomItemName = MyPlugin.Instance.Config.Taser.CustomItemName;
        private static string CustomItemDs = MyPlugin.Instance.Config.Taser.CustomItemDs;
        private static Vector3 CustomItemScale = MyPlugin.Instance.Config.Taser.CustomItemScale;
        private static string ConfigModelName = MyPlugin.Instance.Config.Taser.Model;
        private static EffectType[] CustomItemEffectTypes = MyPlugin.Instance.Config.Taser.CustomItemEffectTypes;
        private static float[] CustomItemEffectTime = MyPlugin.Instance.Config.Taser.CustomItemEffectTime;
        private static byte[] CustomItemEffectIntensity = MyPlugin.Instance.Config.Taser.CustomItemEffectIntensity;
        private static bool[] CustomItemEffectAddDuration = MyPlugin.Instance.Config.Taser.CustomItemEffectAddDuration;
        private static float[] CustomItemEffectAddLateDuration = MyPlugin.Instance.Config.Taser.CustomItemEffectAddLateDuration;
